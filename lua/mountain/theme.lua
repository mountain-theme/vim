...
theme.loadEditor = function ()
	...
	local editor = {
		...
		ColorColumn =			{ fg = mountain.yoru, bg = mountain.iwa },
		Conceal =    			{ fg = mountain.iwa },
		Cursor =     			{ fg = mountain.yuki, bg = mountain.yoru, style = 'reverse' },
		CursorIM =   			{ fg = mountain.yuki, bg = mountain.yoru, style = 'reverse' },
		Directory =  			{ fg = mountain.ajisai, bg = mountain.yoru },
		DiffAdd =    			{ fg = mountain.kusa, bg = mountain.yoru, style = 'reverse' },
		DiffChange = 			{ fg = mountain.ajisai, bg = mountain.yoru, style = 'reverse' },
		DiffDelete = 			{ fg = mountain.ichigo, bg = mountain.yoru, style = 'reverse' },
		DiffText =   			{ fg = mountain.ume, bg = mountain.yoru, style = 'reverse' },
		...
		IncSearch =  			{ fg = mountain.aki, bg = mountain.yoru, style = 'reverse' },
    		LineNr =     			{ fg = mountain.amagumo },
		CursorLineNr =			{ fg = mountain.okami },
		MatchParen = 			{ fg = mountain.yuyake, bg = mountain.yoru, style = 'bold' },
		...
		SpellBad =   			{ fg = mountain.kaen, bg = mountain.yoru, style = 'italic,undercurl' },
		SpellCap =			{ fg = mountain.suna, bg = mountain.yoru, style = 'italic,undercurl' },
		SpellLocal =			{ fg = mountain.shinkai, bg = mountain.yoru, style = 'italic,undercurl' },
		SpellRare =			{ fg = mountain.sora, bg = mountain.yoru, style = 'italic,undercurl' },
		...
		Visual =			{ fg = mountain.yoru, bg = mountain.amagumo },
		VisualNOS =			{ fg = mountain.kaen, bg = mountain.yoru },
		WarningMsg =			{ fg = mountain.yuyake },
		Whitespace =			{ fg = mountain.amagumo },
		WildMenu =			{ bg = mountain.iwa },
		CursorColumn =			{ fg = mountain.yoru, bg = mountain.iwa},
		CursorLine =			{ fg = mountain.yoru, bg = mountain.iwa},
	}
...
--		TSUnderline =			{ fg = mountain.yuki, bg = mountain.yoru, style = 'underline' },
--		TSStrike =			{ },
--		TSTitle =			{ fg = mountain.ume, bg = mountain.yoru, style = 'bold' },
